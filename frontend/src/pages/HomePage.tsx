...
export default function HomePage() {
  ...
  const premiumProjects = [
    {
      ...
      description:
        "Plataforma de comercio electrónico escalable con carrito inteligente, pagos integrados y panel de administración avanzado.",
      image:
    ...
    },
    {
      ...
      description:
        "Aplicación de seguimiento de salud con IA que analiza rutinas de ejercicio, nutrición y progreso personalizado.",
      image:
    ...
    },
    {
      ...
      description:
        "Dashboard financiero en tiempo real con visualización de datos, predicciones de mercado y gestión de portafolios.",
      image:
  ...
  const prevProject = () => {
    setCurrentProject((prev) =>
      prev === 0 ? premiumProjects.length - 1 : prev - 1
    );
    setAutoPlay(false);
    setTimeout(() => setAutoPlay(true), 10000);
  };
  ...
  return (
    <div className="relative min-h-screen border border-green-400 overflow-hidden bg-gradient-to-br from-gray-900 via-purple-900/20 to-pink-900/20 text-white">
      ...
      <div className="relative z-10">
        ...
        <section className="min-h-[80vh] flex items-center justify-center px-4 md:px-8 lg:px-12 xl:px-20 py-12 md:py-20">
          <div className="max-w-7xl w-full">
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
              ...
              <div className="space-y-7 border border-green-50 animate-fade-in-up delay-300">
                <ProfileCard
                  image="/img/foto.jpg"
        ...
        {/*seion de las ccard codigo limpio*/}
              ...
              {[
                {
                  ...
                  description:
                    "Aplicaciones optimizadas para velocidad y escalabilidad",
                ...
                },
                {
                  ...
                  title: "Código Limpio",
                  description:
                    "Arquitectura sólida y mantenible con mejores prácticas",
                ...
                },
                {
                  ...
                  description:
                    "Interfaces intuitivas que encantan a los usuarios",
                ...
                >
                  <div
                    className={`p-4 bg-gradient-to-r ${item.gradient} rounded-xl w-fit mb-6 group-hover:scale-110 transition-transform duration-300`}
                  >
                    {item.icon}
                  </div>
